...
export default function Create({ insurers, partners }) {
    ...
    return (
        <DashboardLayout>
            <div className="max-w-2xl">
                <h1 className="text-lg font-semibold">Create CD Account</h1>
                <p className="text-sm text-slate-500">Add a new CD account</p>
                ...
                <form onSubmit={submit} className="mt-6 space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button type="submit" disabled={processing} className="bg-indigo-600 text-white px-4 py-2 rounded-md">Create Account</button>
                    </div>
                </form>
            </div>
        </DashboardLayout>
