...
export default function Create() {
    const { data, setData, post, processing, errors } = useForm({
        name: '', email: '', mobile_no: '', company_name: '', website: '', location: ''
    });

    const [suggestions, setSuggestions] = useState([]);
    const LOCATION_SUGGEST_URL = '/api/locations?q='; // simple string URL to fetch suggestions
        ...
        <DashboardLayout>
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-sm text-slate-500">Add a new partner to the system</p>
                </div>
            ...
            <form onSubmit={submit} className="bg-white p-6 rounded-md border shadow-sm">
                ...
                <div className="mt-6">
                    <button type="submit" disabled={processing} className="bg-indigo-600 text-white px-5 py-2 rounded-md shadow">Create Partner</button>
